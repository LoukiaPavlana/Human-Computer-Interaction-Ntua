...
class DinnerTrackWidget extends StatefulWidget {
  const DinnerTrackWidget({Key? key}) : super(key: key);
  @override
  State<StatefulWidget> createState() => _DinnerTrackWidgetState();
}

class _DinnerTrackWidgetState extends State<DinnerTrackWidget> {
  final _foods = <Food> [];
