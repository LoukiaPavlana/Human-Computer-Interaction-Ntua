...
class BreakfastTrackWidget extends StatefulWidget {
  const BreakfastTrackWidget({Key? key}) : super(key: key);
  @override
  State<StatefulWidget> createState() => _BreakfastTrackWidgetState();
}

class _BreakfastTrackWidgetState extends State<BreakfastTrackWidget> {
  final _foods = <Food> [];
