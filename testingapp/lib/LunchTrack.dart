...
class LunchTrackWidget extends StatefulWidget {
  const LunchTrackWidget({Key? key}) : super(key: key);
  @override
  State<StatefulWidget> createState() => _LunchTrackWidgetState();
}

class _LunchTrackWidgetState extends State<LunchTrackWidget> {
  final _foods = <Food> [];
